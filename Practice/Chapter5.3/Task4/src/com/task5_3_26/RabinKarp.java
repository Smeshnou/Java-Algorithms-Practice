...
public class RabinKarp {
    ...
    public static boolean cycle(String str1, String str2){
        if(str1.length() != str2.length()){
            return false;
        }
        str1 = str1 + str1;
        RabinKarp rabinKarp = new RabinKarp(str2);
        int include = rabinKarp.search(str1);
        return include != str1.length();
    }

    public static void main(String[] str){
        System.out.println(RabinKarp.cycle("topal", "palto")); 
    }
}
